...
current directory.
"""
'''install file main.py of brython for pyrhon under 3.10 '''
import os
import shutil
import argparse
import pathlib
...
def main():
    ...
    elif args.subcommand == 'make_modules':
        if args.reset:
    ...
    elif args.subcommand == 'make_dist':
    ...
    elif args.subcommand ==  'make_file_system':
    ...
    elif args.subcommand ==  'make_package':
